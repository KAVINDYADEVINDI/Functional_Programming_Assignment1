object Q4 {
  ...
  def main(args:Array[String])
  {
   ...
   var acc1 =new account("971741",1000234,5000)
   var acc2  =new account("971742",1000235,-67.0)
   var acc3=new account("971743",1000236,-0.09)
   var acc4 =new account("971744",1000237,100.0)
  ...
  // sum of the all account balance
